                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <!-- add_form -->
                                                <form action="{{ route('governorates.update', 'test') }}"
                                                    method="post">
                                                    {{ method_field('patch') }}
                                                    @csrf
                                                    <div class="row">
                                                        ...
                                                        <div class="col">
                                                            <label for="name_en"
                                                                class="mr-sm-2">{{ trans('governorate.stage_name_en') }}
                                                                :</label>
                                                            <input type="text" class="form-control"
                                                                value="{{ $governorate->getTranslation('name', 'en') }}"
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('governorates.store') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <label for="name" class="mr-sm-2">{{ __('Governorate Ar Name') }}
                                    :</label>
                                <input id="name" type="text" name="name" class="form-control">
                            </div>

                            <div class="col">
                                <label for="name_en" class="mr-sm-2">{{ __('Governorate En Name') }}
                                    :</label>
